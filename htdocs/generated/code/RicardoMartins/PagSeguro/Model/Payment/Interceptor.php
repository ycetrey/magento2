<?php
namespace RicardoMartins\PagSeguro\Model\Payment;

/**
 * Interceptor class for @see \RicardoMartins\PagSeguro\Model\Payment
 */
class Interceptor extends \RicardoMartins\PagSeguro\Model\Payment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $extensionFactory, $customAttributeFactory, $paymentData, $scopeConfig, $logger, $moduleList, $localeDate, $countryFactory, $pagSeguroHelper, $pagSeguroAbModel, $adminSession, $data);
    }
