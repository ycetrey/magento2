...
class Interceptor extends \Temando\Shipping\Controller\Adminhtml\Rma\Shipment\Create implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Temando\Shipping\Model\Config\ModuleConfigInterface $config, \Temando\Shipping\Model\ResourceModel\Rma\RmaAccess $rmaAccess)
    {
        $this->___init();
        parent::__construct($context, $config, $rmaAccess);
    }
