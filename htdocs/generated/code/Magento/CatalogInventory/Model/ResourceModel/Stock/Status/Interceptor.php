...
class Interceptor extends \Magento\CatalogInventory\Model\ResourceModel\Stock\Status implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function saveProductStatus($productId, $status, $qty, $websiteId, $stockId = 1)
    {
        ...
        if (!$pluginInfo) {
            return parent::saveProductStatus($productId, $status, $qty, $websiteId, $stockId);
        } else {
            return $this->___callPlugins('saveProductStatus', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductsStockStatuses($productIds, $websiteId, $stockId = 1)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductsStockStatuses($productIds, $websiteId, $stockId);
        } else {
            return $this->___callPlugins('getProductsStockStatuses', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getWebsiteStores()
    {
        ...
        if (!$pluginInfo) {
            return parent::getWebsiteStores();
        } else {
            return $this->___callPlugins('getWebsiteStores', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductsType($productIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductsType($productIds);
        } else {
            return $this->___callPlugins('getProductsType', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductCollection($lastEntityId = 0, $limit = 1000)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductCollection($lastEntityId, $limit);
        } else {
    ...
    public function getProductStatus($productIds, $storeId = null)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getProductStatus', func_get_args(), $pluginInfo);
        }
    }
