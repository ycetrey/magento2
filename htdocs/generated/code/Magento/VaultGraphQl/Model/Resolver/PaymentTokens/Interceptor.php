...
class Interceptor extends \Magento\VaultGraphQl\Model\Resolver\PaymentTokens implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Vault\Model\PaymentTokenManagement $paymentTokenManagement, \Magento\CustomerGraphQl\Model\Customer\GetCustomer $getCustomer)
    {
        $this->___init();
        parent::__construct($paymentTokenManagement, $getCustomer);
    }
