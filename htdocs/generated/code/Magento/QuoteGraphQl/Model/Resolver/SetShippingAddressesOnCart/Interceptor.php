...
class Interceptor extends \Magento\QuoteGraphQl\Model\Resolver\SetShippingAddressesOnCart implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\QuoteGraphQl\Model\Cart\GetCartForUser $getCartForUser, \Magento\QuoteGraphQl\Model\Cart\SetShippingAddressesOnCartInterface $setShippingAddressesOnCart)
    {
        $this->___init();
        parent::__construct($getCartForUser, $setShippingAddressesOnCart);
    }
