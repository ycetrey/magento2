...
class Interceptor extends \Magento\CustomerGraphQl\Model\Resolver\IsSubscribed implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\CustomerGraphQl\Model\Customer\GetCustomer $getCustomer, \Magento\Newsletter\Model\SubscriberFactory $subscriberFactory)
    {
        $this->___init();
        parent::__construct($getCustomer, $subscriberFactory);
    }
