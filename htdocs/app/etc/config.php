...
return [
    'modules' => [
        ...
        'Etatvasoft_Productsattachment' => 1,
        'Etatvasoft_WhatsAppChat' => 1,
        'Frenet_Shipping' => 1,
        ...
        'MagestyApps_FBComments' => 1,
        'McAfeeSecure_McAfeeSecure' => 1,
        'MercadoPago_Core' => 1,
        'RicardoMartins_PagSeguro' => 1,
        'Techspot_Brcustomer' => 1,
        'Temando_Shipping' => 1,
        'Vertex_Tax' => 1,
        'Wealthsystems_Buyer' => 1,
        'Wealthsystems_Masterb2b' => 1,
        'Wealthsystems_Masterbargain' => 1,
        'Wealthsystems_Mastercredit' => 1,
        'Wealthsystems_Masterdirectdata' => 1,
        'Wealthsystems_Masterprice' => 1,
        'Wealthsystems_Masterrestriction' => 1,
        'Wealthsystems_Masterstock' => 1,
        'Wealthsystems_Mastertheme' => 1
    ]
];
