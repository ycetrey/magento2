...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(
        ...
        if (version_compare($context->getVersion(), "1.0.6", "<")) {
            $this->upgradeVersionOneZeroSix($customerSetup);
        }

        if (version_compare($context->getVersion(), "1.0.7", "<")) {
            $this->upgradeVersionOneZeroSeven($customerSetup);
        }
     ...
     * @return void
     */
    private function upgradeVersionOneZeroSix($customerSetup)
    {
        //Legal Document
        $customerSetup->addAttribute(\Magento\Customer\Model\Customer::ENTITY, 'legal_document', [
            'type' => 'varchar',
        ...
        $attribute = $customerSetup->getEavConfig()->getAttribute('customer', 'legal_document')
            ->addData(['used_in_forms' => [
                'adminhtml_customer',
                'adminhtml_checkout',
                'customer_account_create',
        ...
        //Blocked
        $customerSetup->addAttribute(\Magento\Customer\Model\Customer::ENTITY, 'is_block', [
            'type' => 'varchar',
            'label' => 'Is Block',
            'input' => 'text',
            'source' => '',
        ...
        $attribute = $customerSetup->getEavConfig()->getAttribute('customer', 'is_block')
            ->addData(['used_in_forms' => [
                'adminhtml_customer',
                'adminhtml_checkout'
                ]
     ...
     * @return void
     */
    private function upgradeVersionOneZeroSeven($customerSetup)
    {
        $customerSetup->addAttribute(\Magento\Customer\Model\Customer::ENTITY,'lastname',[
                'required' => false
        ]);
    }
